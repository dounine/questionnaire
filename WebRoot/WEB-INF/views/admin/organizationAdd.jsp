...
<div style="padding: 3px;">
	<form id="organizationAddForm" method="post">
		<table class="grid">
			<tr>
				<td>编号</td>
				<td><input name="code" type="text" style="width: 134px;" class="easyui-validatebox" data-options="required:true" ></td>
				<td>部门名称</td>
				<td><input name="name" style="width: 134px;" type="text" class="easyui-validatebox" data-options="required:true" ></td>
			...
			<tr>
				<td>答题占比</td>
				<td ><input name="percent" style="width: 140px;"/></td>
				<td>部门人数</td>
				<td ><input name="deptotalnum" style="width: 134px;"/></td>
			</tr>
			<tr>
				<td>上级部门</td>
			...
			<tr>
				<td>地址</td>
				<td colspan="3"><input name="address" style="width: 378px;"/></td>
			</tr>
		</table>
	</form>
</div>