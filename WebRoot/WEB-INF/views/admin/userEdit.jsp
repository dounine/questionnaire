	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
		<form id="userEditForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					<td>学历</td>
					<td><input id="educa" name="educa"  value="${user.educa}" style="width: 140px;"/></td>
					<td>司龄</td>
					<td><input id="divisionage" name="divisionage"  value="${user.divisionage}"  style="width: 140px;" /></td>
				</tr>
				<tr>
					<td>职位</td>
					<td><input id="post" name="post"  value="${user.post}" style="width: 140px;"/></td>
					<td>职级</td>
					<td><input id="postlevel" name="postlevel"   value="${user.postlevel}"  style="width: 140px;" /></td>
				</tr>
			</table>
		</form>
	</div>
