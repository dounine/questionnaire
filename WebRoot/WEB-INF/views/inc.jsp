...
<!-- 百度Ueditor -->
<%-- <script type="text/javascript" src="${ctx}/jslib/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="${ctx}/jslib/ueditor/ueditor.all.js"></script> --%>
<script type="text/javascript" src="${ctx}/kindeditor-4.1.2/kindeditor.js"></script>
<script type="text/javascript" src="${ctx}/kindeditor-4.1.2/kind.js"></script>


<!-- 自定义工具类 -->
<script type="text/javascript" src="${ctx}/jslib/survey.js" charset="utf-8"></script>

<!-- 扩展EasyUI图标 -->
<link rel="stylesheet" href="${ctx}/style/survey.css" type="text/css">
