...
<div style="padding: 3px;">
	<form id="organizationEditForm" method="post">
		<table class="grid">
			...
			<tr>
				<td>答题占比</td>
				<td  ><input name="percent" style="width: 140px;" value="${organization.percent}" /></td>
				<td>部门人数</td>
				<td colspan="3"><input name="deptotalnum" style="width: 134px;" value="${organization.deptotalnum}" /></td>
			</tr>
			<tr>
				<td>上级部门</td>
